...
Assuming you use [GitHub](https://github.com) and your modeling work is version controlled, GitHub already creates "homepages" for your repository using a `README.md` file. We can enrich a repository README with model results and diagnostics, and have it always be the first thing someone sees when they find your repo.
